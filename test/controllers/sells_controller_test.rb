...
class SellsControllerTest < ActionController::TestCase
  ...
  test "should create sell" do
    assert_difference('Sell.count') do
      post :create, sell: { company_id: @sell.company_id, price_total: @sell.price_total, product_id: @sell.product_id, user_id: @sell.user_id }
    end
  ...
  test "should update sell" do
    patch :update, id: @sell, sell: { company_id: @sell.company_id, price_total: @sell.price_total, product_id: @sell.product_id, user_id: @sell.user_id }
    assert_redirected_to sell_path(assigns(:sell))
  end
